...
\midrule
Operating Systems & \placeholder{Threads to run camera and alerts at the same time} & \placeholder{Processing Layer}\\
DBMS & \placeholder{SQLite for storing driver details and past records} & \placeholder{Database Layer}\\
\bottomrule
\end{tabularx}
\end{center}
\vfill
